...
- **Frontend**: Classic frontend is the default (React 19, TypeScript, Rsbuild, Semi Design, Tailwind CSS)
...
web/             — Frontend themes container
  web/classic/   — Default frontend (React 19, Rsbuild, Semi Design, Tailwind)
  web/default/   — New frontend (React 19, Rsbuild, Base UI, Tailwind)
  web/classic/src/i18n/ — Default frontend internationalization (i18next, zh-CN/zh-TW/en/fr/ru/ja/vi)
```
...
- Translation files: `web/classic/src/i18n/locales/{lang}.json` — flat JSON
...
Use `bun` as the preferred package manager and script runner for the default frontend (`web/classic/` directory):
