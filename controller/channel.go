...
func isAdminRequest(c *gin.Context) bool {
	...
	switch v := role.(type) {
	case int:
		return v >= common.RoleAdminUser && v < common.RoleRootUser
	case int64:
		return v >= int64(common.RoleAdminUser) && v < int64(common.RoleRootUser)
	case float64:
		return v >= float64(common.RoleAdminUser) && v < float64(common.RoleRootUser)
	default:
		return false
	}
}
